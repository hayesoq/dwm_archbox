...
static const char *fonts[]          = { "JetBrainsMono NFP ExtraBold:size=14" };
static const char dmenufont[]       = "JetBrainsMono NFP ExtraBold:size=14";
//top bar alpha
...
/* tagging */
static const char *tags[] = { "󰣇", "", "󰓓", "", "󰕼", "󰢚" /*"7", "8", "9"*/ };
...
static const char *musiccmd[]  = { "spotify-launcher", NULL };
static const char *gamescmd[]  = { "steam", NULL };
...
static const Key keys[] = {
  ...
  { ShiftMask,                    XK_Print,  spawn,          SHCMD("~/.local/bin/screenshotsel.sh") },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
